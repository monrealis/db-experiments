...
import eu.vytenis.dbe.mybatis.model.RequestExample.Criteria;
import eu.vytenis.dbe.mybatis.model.RequestExample.Criterion;
...
public class RequestSqlProvider {
    ...
    public String updateByPrimaryKeySelective(Request record) {
        ...
        if (record.getApartmentId() != null) {
            sql.SET("apartment_id = #{apartmentId,jdbcType=INTEGER}");
        }
